...
if [ -z "${NEBIUS_SA_ACCESS_KEY_ID}" ]; then
  ...
  echo "Using existing access key: ${NEBIUS_SA_ACCESS_KEY_ID}"
fi
...
if [ -z "${AWS_ACCESS_KEY_ID}" ]; then
  ...
  echo "Using existing access key: ${AWS_ACCESS_KEY_ID}"
fi
...
if [ -z "${AWS_SECRET_ACCESS_KEY}" ]; then
  ...
  echo "Using existing secret access key: ${AWS_SECRET_ACCESS_KEY}"
fi
